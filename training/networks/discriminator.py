...
class Discriminator(nn.Module):
    ...
    def __init__(self, args):
        """Initializer.
        Args:
            args.model.discriminator: discriminator hyperparameters.
        """
        super().__init__()
        self.args = args
        self.mpd = MultiPeriodDiscriminator(
            args.model.discriminator.channels,
            args.model.discriminator.periods,
            args.model.discriminator.kernels,
            args.model.discriminator.strides,
            args.model.discriminator.postkernels,
            args.model.discriminator.leak)
